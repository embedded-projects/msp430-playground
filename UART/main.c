...
/**
 * Handle the received byte and calls the needed function
 */
...
/**
 * Reads ADC 'chan' once using an internal reference, 'ref' determines if the 2.5V or 1.5V reference is used
 */
...
/**
 * Transmit the value currently in TXByte. The function waits till it is finished transmitting before it returns
 */
void Transmit(){
...
__interrupt void ADC10_ISR(void){
	...
	__bic_SR_register_on_exit(CPUOFF);	// Enables CPU so the main while loop continues
}
