 ...
 * @brief This module should only contain a call on Device_Init and an application
 * call, such as Applications_AstableMultivibrator_Run()
 *
 **/
...
void main(void) {
	...
	Applications_AstableMultivibrator_Run();
}
